...
export default function Hero() {
    return (
        <section className="relative min-h-[85vh] md:min-h-[90vh] flex items-center pt-24 md:pt-24 pb-6 md:pb-16 overflow-hidden bg-mist-white">
            {/* Background elements */}
            ...
            <div className="container max-w-screen-2xl px-4 md:px-8 grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center relative z-10">
                <div className="space-y-4 md:space-y-6 lg:space-y-8 text-center lg:text-left">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight leading-[1.15] md:leading-[1.1] text-navy animate-in fade-in slide-in-from-left-8 duration-1000 delay-200">
                        Crafting Digital <br />
                        <span className="text-gradient-gold">Masterpieces</span> <br />
                        for Your Business
                    </h1>

                    <p className="text-sm md:text-base lg:text-lg text-navy/60 max-w-xl mx-auto lg:mx-0 leading-relaxed animate-in fade-in slide-in-from-left-8 duration-1000 delay-300">
                        We transform ambitious ideas into high-performance websites that captivate audiences and accelerate growth.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4 justify-center lg:justify-start pt-1 sm:pt-2 md:pt-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
                ...
                <div className="relative group animate-in fade-in zoom-in duration-1000 delay-300">
                    ...
                    <div className="relative aspect-[4/3] md:aspect-square lg:aspect-[4/5] rounded-[1rem] sm:rounded-[1.5rem] md:rounded-[2rem] lg:rounded-[3rem] overflow-hidden border border-navy/5 shadow-2xl shadow-navy/10 group-hover:scale-[1.02] transition-transform duration-700 max-w-[280px] sm:max-w-xs md:max-w-sm lg:max-w-lg mx-auto flex items-center justify-center">
                        <Image
                            src="/hero-img-3.png"
                        ...
                        <div className="absolute bottom-3 sm:bottom-4 md:bottom-8 left-3 sm:left-4 md:left-8 right-3 sm:right-4 md:right-8 flex flex-wrap gap-1.5 sm:gap-2 md:gap-3">
                            {['Innovation', 'Performance', 'Security'].map((tag) => (
                                <span key={tag} className="px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 rounded-lg sm:rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white text-[8px] sm:text-[9px] md:text-[10px] font-bold uppercase tracking-widest shadow-xl">
                                    {tag}
                                </span>
                            ))}
                        </div>
